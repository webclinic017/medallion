...
from MacdStoch import MacdStoch
import sys
sys.path.append('..')
#from providers.ib.IbTrader import IbTrader
from backtesting.macdStochRunner import backtestRunner
...
provider = 'ib'
candle_size = '15m'
start_date = datetime(2020, 12, 15, 0, 0)
...
symbol = 'AMZN'
symbols = [symbol,]
reporter = backtestRunner(MacdStoch, symbols, provider, candle_size, start_date, end_date, init_balance, stratOpts)
